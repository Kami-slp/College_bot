...
file_path_Students_Report =  'C:\\Users\\johnd\\Downloads\\collegebot\\Отчет по студентам.xls'

file_path_Teachers_Report_attendance = 'C:\\Users\\johnd\\Downloads\\collegebot\\Посещаемость по преподавателям.xlsx'

file_path_homework_Report = 'C:\\Users\\johnd\\Downloads\\collegebot\\Отчет по домашним заданиям.xlsx'

file_path_topics = 'C:\\Users\\johnd\\Downloads\\collegebot\\Темы уроков.xls'

file_path_timetable = 'C:\\Users\\johnd\\Downloads\\collegebot\\Расписание групп.xlsx'
